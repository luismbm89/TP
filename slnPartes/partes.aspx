<%@ Page Title="" Language="C#" MasterPageFile="~/Estilo/TicoParts.Master" AutoEventWireup="true" CodeBehind="partes.aspx.cs" Inherits="slnPartes.partes" %>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label>Año:</label>
                                    <asp:DropDownList ID="ddlAnno" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlAnno_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Marca:</label>
                                    <asp:DropDownList ID="ddlMarca" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlMarca_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Modelo:</label>
                                    <asp:DropDownList ID="ddlModelo" runat="server" class="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlModelo_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Parte:</label>
                    ...
                    <div class="col-sm-10">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <asp:DataList ID="dtlPartes" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" OnItemCommand="dtlPartes_ItemCommand" OnSelectedIndexChanged="dtlPartes_SelectedIndexChanged">
                                    <ItemTemplate>
                                        <div class="form-group col-sm-2 text-center">
                                            <div class="panel panel-info">
                                                ...
                                                <div class="panel-body text-center">
                                                    <div class="thumbnail">
                                                        <img src="<%# DataBinder.Eval(Container.DataItem, "imagen") %>" style="width: 100%" onerror="this.src='Imagenes/Diseno/tpImagenOverlay.png';">
                                                    </div>
                                                    <hr />
                                                    <label><%# DataBinder.Eval(Container.DataItem, "NombreProveedor") %></label>
                                                    <br />
                                                    <label><%# DataBinder.Eval(Container.DataItem, "precio","{0:c}") %></label>
                                                </div>
                                                <div class="panel-footer">
                                                    <asp:Button runat="server" ID="myBtn" Text="Ver Repuesto" CommandName="verMas" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "noSeq") %>' CssClass="btn btn-primary" />
                                                </div>
                                            </div>
                                        </div>
                                    </ItemTemplate>
